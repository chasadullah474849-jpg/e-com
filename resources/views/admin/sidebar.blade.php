<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <a href="{{ route('admin.dashboard') }}" class="menu-link">
        ...
        <li class="menu-item {{ request()->routeIs('admin.varieties.*') ? 'active' : '' }}">
...
<!-- Billboards -->
<li class="menu-item {{ request()->routeIs('admin.billboards.*') ? 'active' : '' }}">
...
<li class="menu-item {{ request()->routeIs('admin.orders.*') ? 'active' : '' }}">
    <a href="{{ route('admin.orders.index') }}" class="menu-link">
        ...
        <li class="menu-item">
            <a href="https://github.com/themeselection/sneat-html-admin-template-free/images" target="_blank" class="menu-link">
