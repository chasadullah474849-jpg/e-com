        ...
        <div class="col-md-3 col-sm-6">
          <div class="footer-menu footer-menu-001">
            <div class="footer-intro mb-4">
              <a href="index.html">
                <img src="{{asset('users/images/main-logo.png')}}" alt="logo">
              </a>
            </div>
            ...
            <div class="social-links">
              <ul class="list-unstyled d-flex flex-wrap gap-3">
                <li>
  <a href="https://www.facebook.com/profile.php?id=61593389337210" target="_blank" rel="noopener noreferrer" class="text-secondary">
        ...
        <div class="row">
          <div class="col-md-6 d-flex flex-wrap">
            <div class="shipping">
              ...
              <img src="{{asset('users/images/arct-icon.png')}}" alt="icon">
              <img src="{{asset('users/images/dhl-logo.png')}}" alt="icon">
            </div>
            <div class="payment-option">
              <span>Payment Option:</span>
              <img src="{{asset('users/images/visa-card.png')}}" alt="card">
              <img src="{{asset('users/images/paypal-card.png')}}" alt="card">
              <img src="{{asset('users/images/master-card.png')}}" alt="card">
            </div>
          </div>
