...
<li class="nav-item">
    <a class="nav-link" href="{{ route('home.contact') }}">Contact</a>
                ...
                @guest
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" id="dropdownAccount" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <ul class="dropdown-menu dropdown-menu-end shadow border-0" aria-labelledby="dropdownAccount">
                @if (Route::has('login'))
                    <li><a href="{{ route('login') }}" class="dropdown-item py-2">Sign In</a></li>
                @endif

                @if (Route::has('register'))
                    <li><a href="{{ route('register') }}" class="dropdown-item py-2">Create Account</a></li>
                @endif
            </ul>
        </li>
    @else
        <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end shadow border-0" aria-labelledby="navbarDropdown">
                <li><a href="{{ url('/profile') }}" class="dropdown-item py-2">My Profile</a></li>
                <li><hr class="dropdown-divider"></li>
                <li>
                    <form action="{{ route('logout') }}" method="POST" class="m-0 p-0" id="logout-form">
                        @csrf
                        <button type="submit" class="dropdown-item py-2 text-danger fw-medium" style="border: none; background: none; width: 100%; text-align: left;">
                            Log Out
                        </button>
                    </form>
                </li>
